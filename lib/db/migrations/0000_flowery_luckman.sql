...
CREATE INDEX "idx_audit_log_target" ON "audit_log" USING btree ("target_table","target_id");--> statement-breakpoint
...
CREATE INDEX "idx_listings_state" ON "listings" USING btree ("state");--> statement-breakpoint
CREATE INDEX "idx_listings_city" ON "listings" USING btree ("city");--> statement-breakpoint
CREATE INDEX "idx_listings_district" ON "listings" USING btree ("district");--> statement-breakpoint
...
CREATE INDEX "idx_notifications_created_at" ON "notifications" USING btree ("user_id","created_at");--> statement-breakpoint
